...
@Service
public class QmsVehicleTypeClassServiceImpl implements QmsVehicTypeClassService {
    private final Logger log = LoggerFactory.getLogger(QmsVehicleTypeClassServiceImpl.class);
    ...
    public QmsVehicleTypeClassServiceImpl(QmsVehicleTypeClassRepository qmsVehicleTypeClassRepository){
