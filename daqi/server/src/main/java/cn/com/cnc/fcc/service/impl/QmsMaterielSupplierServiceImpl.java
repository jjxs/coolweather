...
/**
 * QmsMaterielSupplierServiceImpl
 * @author DL0777
 */
@Service
public class QmsMaterielSupplierServiceImpl implements QmsMaterielSupplierService {

    private final Logger log = LoggerFactory.getLogger(QmsMaterielSupplierServiceImpl.class);
    ...
    public QmsMaterielSupplierServiceImpl(QmsMaterielSupplierRepository qmsMaterielSupplierRepository, EntityManagerFactory emf) {
    ...
    public List<QmsMaterielSupplierDto> qmsMaterielSupplierFindAll(String materielCd, String materielName, String supplierCd, String supplierName) {
        ...
        try {
            ...
            qmsMaterielSupplierDtos = query.unwrap(org.hibernate.query.NativeQuery.class)
    ...
    String getfindAllSql(String materielCd, String materielName, String supplierCd, String supplierName) {
    ...
    public QmsMaterielSupplierDto findById(Long id) {
        ...
        try {
            ...
            qmsMaterielSupplierDto = (QmsMaterielSupplierDto) query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("materielId", StandardBasicTypes.LONG)
                .addScalar("supplierId", StandardBasicTypes.LONG)
                .addScalar("materielCd", StandardBasicTypes.STRING)
