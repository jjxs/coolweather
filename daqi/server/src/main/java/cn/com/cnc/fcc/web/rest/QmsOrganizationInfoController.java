...
public class QmsOrganizationInfoController {
	...
	private final Logger log =LoggerFactory.getLogger(QmsOrganizationInfoController.class);

	private final QmsOrganizationInfoService qmsOrganizationInfoService;
	...
	private final TreeCommon treeCommon;
	public QmsOrganizationInfoController(QmsOrganizationInfoService qmsOrganizationInfoService,QmsOrganizationInfoRepository qmsOrganizationInfoRepository,TreeCommon treeCommon){
		this.qmsOrganizationInfoService = qmsOrganizationInfoService;
		this.qmsOrganizationInfoRepository = qmsOrganizationInfoRepository;
		this.treeCommon = treeCommon;
	}
	...
	@Timed
	public ResponseEntity<QmsOrganizationInfo> createOrganizationInfo(@RequestBody QmsOrganizationInfo qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsOrganizationInfo> updateOrganizationInfo(@Valid @RequestBody QmsOrganizationInfo qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsOrganizationInfo> getOrganizationInfoss(@PathVariable Long id) {
	...
	@Timed
	public Integer deleteOrganizationTypeInfo(@PathVariable String id) {
	...
	// 节点排序
	//	public class NodeOrderComparator implements Comparator<QmsOrganizationInfoDTO>{
	//		public int compare(QmsOrganizationInfoDTO n1, QmsOrganizationInfoDTO n2) {
