...
@Service
public class QmsQualityControlDetailsServiceImpl implements QmsQualityControlDetailsService {
    ...
    public QmsQualityControlDetailsServiceImpl(QmsProductionInspectionValueRepository qmsProductionInspectionValueRepository) {
    ...
    public List<ProductProcessCheckDTO> qmsProductProcessSelfFindAll(HttpServletRequest request) {
        ...
        try {
            ...
            qmsProductProcessDto = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("materielCd", StandardBasicTypes.STRING)
                .addScalar("materielId", StandardBasicTypes.INTEGER)
                .addScalar("bomTechnologyId", StandardBasicTypes.INTEGER)
                .addScalar("workno", StandardBasicTypes.STRING)
                .addScalar("materielName", StandardBasicTypes.STRING)
                .addScalar("processName", StandardBasicTypes.STRING)
                .addScalar("serialNumber", StandardBasicTypes.STRING)
                .addScalar("furnace", StandardBasicTypes.STRING)
                .addScalar("remark", StandardBasicTypes.STRING)
                .addScalar("isOk", StandardBasicTypes.STRING)
...
//        }
        ...
        try {
            ...
            productProcessCheckList = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("isOk", StandardBasicTypes.STRING)
                .addScalar("approveResultDiff", StandardBasicTypes.STRING)
                .setResultTransformer(transformer)
                .getResultList();
    ...
    public ProductProcessCheckDTO findById(Long id) {
        ...
        try {
            ...
            productProcessCheck = (ProductProcessCheckDTO) query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("bomTechnologyId", StandardBasicTypes.INTEGER)
                .addScalar("processId", StandardBasicTypes.INTEGER)
                .addScalar("materielId", StandardBasicTypes.INTEGER)
                .addScalar("materielCd", StandardBasicTypes.STRING)
                .addScalar("materielName", StandardBasicTypes.STRING)
                .addScalar("workno", StandardBasicTypes.STRING)
                ...
                .addScalar("furnace", StandardBasicTypes.STRING)
                .addScalar("isOk", StandardBasicTypes.STRING)
                .addScalar("makeTime", ZonedDateTimeType.INSTANCE)
    ...
    String qmsProductProcessFindById(Long id){
    ...
    private String qmsChackPreProcessSql(JSONObject jsonObject) {
        StringBuffer sql = new StringBuffer();
    ...
    String qmsProductProcessFindAll(String materielCd, String materielName, String processName, String serialNumber, String furnace, String isOK, String workno, String inspectionDiff) {
	    StringBuffer sql = new StringBuffer();
    ...
    public List<QmsPartsAssemblyRelationDto> findAssemblyRelationByPid(Integer pid) {
        ...
        try {
            ...
            result = query.unwrap(org.hibernate.query.NativeQuery.class)
//                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("materielId", StandardBasicTypes.INTEGER)
                .addScalar("productMode", StandardBasicTypes.STRING)
                .addScalar("assemblyCount", StandardBasicTypes.INTEGER)
                .addScalar("materielName", StandardBasicTypes.STRING)
                .addScalar("madeYmd", StandardBasicTypes.STRING)
                .addScalar("madeFactoryCd", StandardBasicTypes.STRING)
                .addScalar("productionRelationId", StandardBasicTypes.INTEGER)
                .addScalar("partsAssemblyRelationId", StandardBasicTypes.INTEGER)
                .addScalar("HID", StandardBasicTypes.INTEGER)
                .addScalar("bianHao", StandardBasicTypes.STRING)
                .addScalar("actualUseLocation", StandardBasicTypes.STRING)
                .addScalar("entryType", StandardBasicTypes.STRING)
    ...
    public List<QmsQualityControlDetailsDto> findByBomTechnologyId(Integer pId, String isDetails) {
        ...
        try {
            ...
            result = query.unwrap(org.hibernate.query.NativeQuery.class)
                ...
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("bomTechnologyId", StandardBasicTypes.INTEGER)
                .addScalar("controlId", StandardBasicTypes.INTEGER)
                .addScalar("resultId", StandardBasicTypes.INTEGER)
                .addScalar("inspectionItem", StandardBasicTypes.STRING)
                .addScalar("inspectionInstrument", StandardBasicTypes.STRING)
                .addScalar("technicalRequirement", StandardBasicTypes.STRING)
                .addScalar("resultPlaceDiff", StandardBasicTypes.STRING)
                .addScalar("placeDiff", StandardBasicTypes.STRING)
                .addScalar("standard", StandardBasicTypes.DOUBLE)
                .addScalar("upperDeviation", StandardBasicTypes.DOUBLE)
                .addScalar("lowerDeviation", StandardBasicTypes.DOUBLE)
                .addScalar("inspectionResultDiff", StandardBasicTypes.STRING)
                .addScalar("abcType", StandardBasicTypes.STRING)
                .addScalar("testValue", StandardBasicTypes.STRING)
                .addScalar("modifyUser", StandardBasicTypes.STRING)
                .setResultTransformer(transformer)
                .getResultList();
