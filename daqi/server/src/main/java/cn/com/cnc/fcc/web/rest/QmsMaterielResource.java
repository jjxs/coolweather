...
/**
 * REST controller for managing QmsMateriel.
 */
@RestController
@RequestMapping("/api")
public class QmsMaterielResource {

    private final Logger log = LoggerFactory.getLogger(QmsMaterielResource.class);

    private static final String ENTITY_NAME = "qmsMateriel";

    private final QmsMaterielRepository qmsMaterielRepository;
    @Resource
    private DateUtil dateUtil;

    public QmsMaterielResource(QmsMaterielRepository qmsMaterielRepository) {
        this.qmsMaterielRepository = qmsMaterielRepository;
    }

    /**
     * POST  /qms-materiels : Create a new qmsMateriel.
     *
     * @param qmsMateriel the qmsMateriel to create
     * @return the ResponseEntity with status 201 (Created) and with body the new qmsMateriel, or with status 400 (Bad Request) if the qmsMateriel has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/qms-materiels")
    @Timed
    public ResponseEntity<QmsMateriel> createQmsMateriel(@Valid @RequestBody QmsMateriel qmsMateriel) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/qms-materiels/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * PUT  /qms-materiels : Updates an existing qmsMateriel.
     *
     * @param qmsMateriel the qmsMateriel to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated qmsMateriel,
     * or with status 400 (Bad Request) if the qmsMateriel is not valid,
     * or with status 500 (Internal Server Error) if the qmsMateriel couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/qms-materiels")
    @Timed
    public ResponseEntity<QmsMateriel> updateQmsMateriel(@Valid @RequestBody QmsMateriel qmsMateriel) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, qmsMateriel.getId().toString()))
            .body(result);
    }

    /**
     * GET  /qms-materiels : get all the qmsMateriels.
     *
    ...
    /**
     * GET  /qms-materiels/:id : get the "id" qmsMateriel.
     *
     * @param id the id of the qmsMateriel to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the qmsMateriel, or with status 404 (Not Found)
     */
    @GetMapping("/qms-materiels/{id}")
    @Timed
    public ResponseEntity<QmsMateriel> getQmsMateriel(@PathVariable Long id) {
    ...
    /**
     * DELETE  /qms-materiels/:id : delete the "id" qmsMateriel.
     *
     * @param id the id of the qmsMateriel to delete
     * @return the ResponseEntity with status 200 (OK)
     */
    @DeleteMapping("/qms-materiels/{id}")
    @Timed
    public ResponseEntity<Void> deleteQmsMateriel(@PathVariable Long id) {
