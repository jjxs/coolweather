...
public class QmsSuppliersInfoServiceImpl implements QmsSuppliersInfoService{
	...
	private final Logger log = LoggerFactory.getLogger(QmsSuppliersInfoServiceImpl.class);
...
//                        list.add(qmsSupplier);
    ...
    public List<SupplierPopDto> findBySupplierCdAndSupplierName(String supplierCd,String supplierName, String materielId) {
        ...
        try {
            ...
            qmsSuppliers = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("supplierCd", StandardBasicTypes.STRING)
                .addScalar("supplierName", StandardBasicTypes.STRING)
                .addScalar("assRecord", StandardBasicTypes.STRING)
                .addScalar("remark", StandardBasicTypes.STRING)
                .addScalar("supplierClassName", StandardBasicTypes.STRING)
    ...
    String getSupplierSql(String supplierCd, String supplierName, String materielId) {
