...
private final static String SYSPROP_HOST_NAME = "host.name";
    
	private final static String SYSPROP_PORT_NUMBER = "port.number";
    
	private final static String SYSPROP_IP_ADDRESS = "ip.address";
