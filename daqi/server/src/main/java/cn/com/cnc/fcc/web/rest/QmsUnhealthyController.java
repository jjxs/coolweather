...
public class QmsUnhealthyController {
	private final Logger log = LoggerFactory.getLogger(QmsUnhealthyController.class);
	...
	public QmsUnhealthyController(QmsUnhealthyRepository qmsUnhealthyRepository) {
	...
	public HashMap<String,Object> getUnhealthiesTess(@RequestBody HashMap<String,Object> param){
	...
	@Timed
	public ResponseEntity<QmsUnhealthy> createUnhealthiesInfo(@RequestBody QmsUnhealthy qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsUnhealthy> updateUnhealthiesInfo(@Valid @RequestBody QmsUnhealthy qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsUnhealthy> getUnhealthiesInfoss(@PathVariable Long id) {
	...
	@Timed
	public Integer deleteUnhealthiesInfo(@PathVariable String id) {
