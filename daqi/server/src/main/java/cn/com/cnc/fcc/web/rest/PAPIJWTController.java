...
public class PAPIJWTController {
	...
	public PAPIJWTController(TokenProvider tokenProvider, AuthenticationManager authenticationManagerImp,
    ...
    @Timed
    public ResponseEntity<JWTToken> authorize(@RequestBody LoginPAPI LoginPAPI) {
		
		UsernamePasswordAuthenticationToken authenticationToken =
	            new UsernamePasswordAuthenticationToken(LoginPAPI.getUsername(), LoginPAPI.getPassword());
    ...
    @Timed
    public ResponseEntity<RbacUser> getalluser(@RequestBody String id) {
