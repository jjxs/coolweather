	...
	public List<QmsOrganizationInfoDTO> getParentNodeListInfo(String materielCd, String materielName) {
		...
		try {
			...
			qmsOrganizationInfoDTO = query.unwrap( org.hibernate.query.NativeQuery.class )
					...
					.addScalar("rootMaterielName",StandardBasicTypes.STRING)
					.addScalar("materielCd",StandardBasicTypes.STRING)
					.addScalar("vehicleType",StandardBasicTypes.STRING)
					.addScalar("rootMaterielCd",StandardBasicTypes.STRING)
	...
	public Integer deleteNodeInfos(String id,String hidVehicleType) {
		...
		try {
			...
			organizationInfo = query.unwrap( org.hibernate.query.NativeQuery.class )
					...
					.addScalar("parentMaterielID",StandardBasicTypes.INTEGER)
