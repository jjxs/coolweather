...
public class QmsMaterielEntryServiceImpl implements QmsMaterielEntryService {
    ...
    private final Logger log = LoggerFactory.getLogger(QmsMaterielEntryServiceImpl.class);
    ...
    public List<QmsMaterielEntryDto> qmsMaterielEntryFindAll(String materielCd, String materielName, String figureNumber, String supplierCd, String supplierName, String specificationType, String purchaseOrderNumber, String flagInspect, String enclosure) {
        ...
        try {
            ...
            qmsMaterielEntrys = query.unwrap(org.hibernate.query.NativeQuery.class)
                ...
                .addScalar("flagInspect", StandardBasicTypes.STRING)
                .addScalar("enclosure", StandardBasicTypes.STRING)
                .addScalar("checkType", StandardBasicTypes.STRING)
                .addScalar("entryDate", StandardBasicTypes.STRING)
    ...
    String getMaterielEntrySql(String materielCd, String materielName, String figureNumber, String supplierCd, String supplierName, String specificationType, String purchaseOrderNumber, String flagInspect, String enclosure) {
    ...
    public JSONObject getEditHeader(String id) {
        ...
        try {
            ...
            Object result = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("materielId", StandardBasicTypes.STRING)
                .addScalar("materielCd", StandardBasicTypes.STRING)
                .addScalar("materielName", StandardBasicTypes.STRING)
                .addScalar("figureNumber", StandardBasicTypes.STRING)
                .addScalar("supplierId", StandardBasicTypes.STRING)
                .addScalar("supplierCd", StandardBasicTypes.STRING)
                .addScalar("supplierName", StandardBasicTypes.STRING)
                .addScalar("specificationType", StandardBasicTypes.STRING)
                .addScalar("purchaseOrderNumber", StandardBasicTypes.STRING)
                .addScalar("packingQuantity", StandardBasicTypes.STRING)
                ...
                .addScalar("castingNum", StandardBasicTypes.STRING)
                .setResultTransformer(transformer)
                .getSingleResult();
    ...
    String getEditHeaderSql(String id) {
        StringBuffer sql = new StringBuffer();
        sql.append("SELECT\n" +
            "\tt01.id,\n" +
