...
@Service
public class QmsMaterielDetailsPopupServiceImpl implements QmsMaterielDetailsPopupService{
	...
	public QmsMaterielDetailsPopupServiceImpl(EntityManagerFactory emf) {
	...
	public List<QmsMaterielDetailsPopupDTO> qmsMaterialTypeFindAll(String materielId, String supplierName) {
		...
		try {
			...
			materialTypeSelectionDto = query.unwrap(org.hibernate.query.NativeQuery.class)
					.addScalar("id", StandardBasicTypes.LONG)
					.addScalar("entryId", StandardBasicTypes.INTEGER)
					.addScalar("goodsCd", StandardBasicTypes.STRING)
					.addScalar("madeFactoryCd", StandardBasicTypes.STRING)
					.addScalar("madeYMD", StandardBasicTypes.STRING)
					.addScalar("entryQuantity", StandardBasicTypes.INTEGER)
	...
	String deleteParentNodeInfo(String materielId, String supplierName) {
