...
public class QmsDefectController {
	...
	private final Logger log = LoggerFactory.getLogger(QmsDefectController.class);
	...
	@Timed
	public ResponseEntity<QmsDefect> createUnhealthiesInfo(@RequestBody QmsDefect qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsDefect> updateUnhealthiesInfo(@Valid @RequestBody QmsDefect qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsDefect> getUnhealthiesInfoss(@PathVariable Long id) {
