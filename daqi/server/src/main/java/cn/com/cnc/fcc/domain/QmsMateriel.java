...
public class QmsMateriel implements Serializable {
    ...
    public String toString() {
        return "QmsMateriel{" +
            ...
            ", materielTypeId=" + getMaterielTypeId() +
            ", propertyType='" + getPropertyType() + "'" +
            ", packgeUnitId=" + getPackgeUnitId() +
            ", useUnitId=" + getUseUnitId() +
            ", conversion=" + getConversion() +
            ", specificationType='" + getSpecificationType() + "'" +
            ", weight=" + getWeight() +
            ", density=" + getDensity() +
            ", workHours=" + getWorkHours() +
            ", taredHours=" + getTaredHours() +
            ", schedulerRoleId=" + getSchedulerRoleId() +
            ", organizationCd='" + getOrganizationCd() + "'" +
            ", inHouseType='" + getInHouseType() + "'" +
            ", vesselAmount=" + getVesselAmount() +
            ", qualityLevel='" + getQualityLevel() + "'" +
            ", texTure='" + getTexTure() + "'" +
            ", mhandlerRoleId=" + getMhandlerRoleId() +
            ", eightPrevention='" + getEightPrevention() + "'" +
            ", ifKey='" + getIfKey() + "'" +
            ", ubiety='" + getUbiety() + "'" +
            ", sapCd='" + getSapCd() + "'" +
            ", isCheck='" + getIsCheck() + "'" +
            ", checkType='" + getCheckType() + "'" +
            ", checkRate=" + getCheckRate() +
