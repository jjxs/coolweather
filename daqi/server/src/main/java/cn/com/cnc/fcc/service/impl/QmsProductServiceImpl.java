...
@Service
public class QmsProductServiceImpl implements QmsProductService {
    ...
    public List<ProductDTO> qmsProductFindAll(String productNumIn, String materielCdIn,String materielNameIn,String productBatchIn,String materielId,String sp){
        ...
        try {
            ...
            ProductDTO = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("productNum", StandardBasicTypes.STRING)
                .addScalar("productBatch", StandardBasicTypes.STRING)
                .addScalar("materielId", StandardBasicTypes.LONG)
    ...
    public List<QmsProductRelationTabDTO> qmsProductFindTabData(String productRelation){
        ...
        try {
            ...
            QmsProductRelationTabDTO = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("productBatch", StandardBasicTypes.STRING)
                .addScalar("materielCd", StandardBasicTypes.STRING)
                .addScalar("figureNumber", StandardBasicTypes.STRING)
                .addScalar("weight", StandardBasicTypes.STRING)
                .addScalar("texTure", StandardBasicTypes.STRING)
                .addScalar("prjName", StandardBasicTypes.STRING)
                .addScalar("materielName", StandardBasicTypes.STRING)
                .addScalar("specificationType", StandardBasicTypes.STRING)
                .addScalar("density", StandardBasicTypes.STRING)
                .addScalar("assemblyCount", StandardBasicTypes.STRING)
                .setResultTransformer(transformer)
                .getResultList();
    ...
    public List<QmsProductRelationTabTwoDTO> qmsProductFindTabDataTwo(String productRelation){
        ...
        try {
            ...
            QmsProductRelationTabTwoDTO = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("organizationName", StandardBasicTypes.STRING)
                .addScalar("technologyCd", StandardBasicTypes.STRING)
                .addScalar("processCd", StandardBasicTypes.STRING)
                .addScalar("prjName", StandardBasicTypes.STRING)
                .addScalar("orderNo", StandardBasicTypes.STRING)
                .addScalar("workGroupCd", StandardBasicTypes.STRING)
                .addScalar("technologyName", StandardBasicTypes.STRING)
                .addScalar("processName", StandardBasicTypes.STRING)
                .addScalar("isControlPoint", StandardBasicTypes.STRING)
                .addScalar("isTest", StandardBasicTypes.STRING)
                .setResultTransformer(transformer)
                .getResultList();
    ...
    public List<QmsProductRelationTabThreeDTO> qmsProductFindTabDataThree(String productRelation){
        ...
        try {
            ...
            QmsProductRelationTabThreeDTO = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .addScalar("supplierCd", StandardBasicTypes.STRING)
                .addScalar("prjName", StandardBasicTypes.STRING)
                .addScalar("purchaseOrderNumber", StandardBasicTypes.STRING)
                .addScalar("madeYmd", StandardBasicTypes.STRING)
                .addScalar("supplierName", StandardBasicTypes.STRING)
                .addScalar("entryQuantity", StandardBasicTypes.STRING)
    ...
    String getfindTabSql(String productRelation) {
    ...
    String getfindTabTwoSql(String productRelation) {
        StringBuffer sql = new StringBuffer();
        sql.append("SELECT\n" +
            "\ta.id AS id,\n" +
    ...
    String getfindTabThreeSql(String productRelation) {
        StringBuffer sql = new StringBuffer();
        sql.append("SELECT\n" +
            "\ta.id as id,\n" +
    ...
    String getfindAllSql(String productNumIn, String materielCdIn,String materielNameIn,String productBatchIn,String materielId,String sp) {
        StringBuffer sql = new StringBuffer();
