...
public class QmsBomTreeController {
	...
	private final Logger log = LoggerFactory.getLogger(QmsBomTreeController.class);
	...
	public QmsBomTreeController(QmsBomRepository qmsBomRepository,QmsMaterielRepository qmsMaterielRepository,QmsVehicleTypeInfoRepository qmsVehicleTypeInfoRepository) {
	...
	@Timed
	public ResponseEntity<QmsBom> createOrganizationInfo(@RequestBody QmsBom qmsOrganizationInfo) throws URISyntaxException {
		...
		return ResponseEntity.created(new URI("/api/qms-bom-infos/" + result.getId()))
	...
	@Timed
	public ResponseEntity<QmsBom> updateOrganizationInfo(@Valid @RequestBody QmsBom qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsBomDetaileDTO> getOrganizationInfoss(@PathVariable Long id) {
	...
	@Timed
	public ResponseEntity<QmsVehicleTypeInfo> getQmsVehicleTypeClass(@PathVariable String id) {
