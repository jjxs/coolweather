...
@Service
public class QmsEntryControlDetailsServiceImpl implements QmsEntryControlDetailsService {

    private final Logger log = LoggerFactory.getLogger(QmsEntryControlDetailsServiceImpl.class);
    ...
    public QmsEntryControlDetailsServiceImpl(QmsEntryControlDetailsRepository qmsEntryControlDetailsRepository, QmsMaterielRepository qmsMaterielRepository, EntityManagerFactory emf) {
    ...
    public List<QmsEntryControlDetailsDTO> selectAllInfo(HashMap<String, Object> param) {
        ...
        try {
            ...
            entryControlDetails = query.unwrap(org.hibernate.query.NativeQuery.class)
                ...
                .addScalar("standard", StandardBasicTypes.STRING)
