...
public class QmsProductionRelation implements Serializable {
    ...
    public String toString() {
        return "QmsProductionRelation{" +
            "id=" + getId() +
            ", productionInspectionId=" + getProductionInspectionId() +
            ", assemblyId=" + getAssemblyId() +
            ", doProductId=" + getDoProductId() +
            ", actualUseLocation='" + getActualUseLocation() + "'" +
            ", assemblyMaterielId=" + getAssemblyMaterielId() +
            ", useProductId=" + getUseProductId() +
            ", fromDiff='" + getFromDiff() + "'" +
            ", confirmUser1='" + getConfirmUser1() + "'" +
            ", confirmTime1='" + getConfirmTime1() + "'" +
            ", confirmUser2='" + getConfirmUser2() + "'" +
            ", confirmTime2='" + getConfirmTime2() + "'" +
            ", remark='" + getRemark() + "'" +
