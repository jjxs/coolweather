...
@Service
public class QmsProductionInspectionImpl implements QmsProductionInspectionService {

    private final Logger log = LoggerFactory.getLogger(QmsProductionInspectionImpl.class);
    ...
    public QmsProductionInspectionImpl(QmsBomTechnologyRepository qmsBomTechnologyRepository, QmsProductionInspectionRepository qmsProductionInspectionRepository, EntityManagerFactory emf) {
        this.emf = emf;
    ...
    public List<ProductProcessCheckDTO> qmsProductProcessFindAll(HttpServletRequest request) {
    ...
    public JSONObject chackPreProcess(String bomTechnologyId, String serialNumber) {
        ...
        try {
            ...
            preProcessList = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("id", StandardBasicTypes.LONG)
                .setResultTransformer(transformer)
                .getResultList();
     ...
     * @return
     */
    private String chackPreProcessSql(String bomTechnologyId) {
        StringBuffer sql = new StringBuffer();
        sql.append(" select   ");
        sql.append(" qbt.id  ");
        sql.append(" FROM  ");
