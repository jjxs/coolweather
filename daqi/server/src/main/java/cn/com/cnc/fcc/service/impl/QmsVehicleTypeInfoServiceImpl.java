...
public class QmsVehicleTypeInfoServiceImpl implements QmsVehicleTypeInfoService {
	...
	private final Logger log = LoggerFactory.getLogger(QmsVehicleTypeInfoServiceImpl.class);
	...
	public List<VehicleTypeInfoDTO> getVehicleTypePopInfo(String vehicleType, String vehicleTypeName) {
        ...
        try {
            ...
            qmsMaterielSupplierDtos = query.unwrap(org.hibernate.query.NativeQuery.class)
                ...
                .addScalar("vehicleTypeName", StandardBasicTypes.STRING)
                .addScalar("vehicleClassName", StandardBasicTypes.STRING)
    ...
    String getVehicleTypePopInfoSql(String vehicleType, String vehicleTypeName) {
