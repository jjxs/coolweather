...
public class QmsMaterielDetailsPopupController {
	private static final Logger log = LoggerFactory.getLogger(QmsMaterielDetailsPopupController.class);
    ...
    @Timed
    public ResponseEntity<QmsMateriel> getQmsMaterielDetails(@PathVariable Long id) {
