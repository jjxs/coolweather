...
@Service
public class QmsOrganizationInfoServiceImpl implements QmsOrganizationInfoService {
	...
	public QmsOrganizationInfoServiceImpl(EntityManagerFactory emf,QmsOrganizationInfoRepository qmsOrganizationInfoRepository) {
		this.emf = emf;
