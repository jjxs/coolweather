...
public class QmsMaterielTypeController {
	...
	private final Logger log = LoggerFactory.getLogger(QmsMaterielTypeController.class);
	@Resource
	...
	@Timed
	public ResponseEntity<QmsMaterielType> createOrganizationInfo(@RequestBody QmsMaterielType qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsMaterielType> updateOrganizationInfo(@Valid @RequestBody QmsMaterielType qmsOrganizationInfo) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<QmsMaterielType> getOrganizationInfoss(@PathVariable Long id) {
