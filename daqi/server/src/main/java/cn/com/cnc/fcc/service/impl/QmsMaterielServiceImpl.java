...
public class QmsMaterielServiceImpl implements QmsMaterielService {
    ...
    private final Logger log = LoggerFactory.getLogger(QmsMaterielServiceImpl.class);
    ...
    @Override
    public Page<QmsMateriel> qmsMaterielFindAll(String bianMa, String gongName, String tuhao,String guige,String shengValue,String shuxingValue,Pageable pageable) {
        // 初始化结果集
        Page<QmsMateriel> resultInfo = null;

        Specification querySpecifi = new Specification<QmsMateriel>() {
        ...
        // 带检索条件查询数据
        resultInfo = qmsMaterielRepository.findAll(querySpecifi,pageable);
                ...
                if(data.size() <= 0) {
                    ...
                    for(int i = 0;i< data.size();i++){
                        ...
                        if(data.getJSONObject(i).getString("productMode")!=""){
                            if(!"M".equals(data.getJSONObject(i).getString("productMode"))&&!"P".equals(data.getJSONObject(i).getString("productMode"))
                                &&!"O".equals(data.getJSONObject(i).getString("productMode"))){
                        ...
                        if(data.getJSONObject(i).getString("checkType")!=""){
                            if(!"1".equals(data.getJSONObject(i).getString("checkType"))&&!"2".equals(data.getJSONObject(i).getString("checkType"))
                                &&!"3".equals(data.getJSONObject(i).getString("checkType"))){
                        ...
                        if(data.getJSONObject(i).getString("eightPrevention")!=""){
                            if(!"1".equals(data.getJSONObject(i).getString("eightPrevention"))&&!"2".equals(data.getJSONObject(i).getString("eightPrevention"))
                                &&!"3".equals(data.getJSONObject(i).getString("eightPrevention"))&&!"4".equals(data.getJSONObject(i).getString("eightPrevention"))
                                &&!"5".equals(data.getJSONObject(i).getString("eightPrevention"))&&!"6".equals(data.getJSONObject(i).getString("eightPrevention"))
                                &&!"7".equals(data.getJSONObject(i).getString("eightPrevention"))&&!"8".equals(data.getJSONObject(i).getString("eightPrevention"))){
    ...
    public List<MaterielPopDto> qmsMaterielFindAll(String materielCd, String materielName, String supplier, String figureNumber, String type, String supplierId) {
        ...
        try {
            ...
            qmsMateriels = query.unwrap(org.hibernate.query.NativeQuery.class)
   ...
   String getMaterielSql(String materielCd, String materielName, String supplier, String figureNumber, String type, String supplierId) {
