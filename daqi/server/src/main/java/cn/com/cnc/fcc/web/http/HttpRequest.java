package cn.com.cnc.fcc.web.http;
...
public class HttpRequest {
	...
	/**
	 * 
	 * @param url This is Full Url
	 * @param mode Request Mode
	 * @param parm This is Parameter(Json Format)
	 * @return Json Result
	 * @throws IOException 
	 */
	public String getData(String url, HttpMode mode, String parm, Map<String, String> heards) throws IOException {
