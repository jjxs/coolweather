...
public class RbacRoleServiceImpl implements RbacRoleService {
	...
	private final Logger log = LoggerFactory.getLogger(RbacRoleServiceImpl.class);
	@Resource
	...
	public RbacRoleServiceImpl(EntityManagerFactory emf) {
		this.emf = emf;
...
//				throw new RuntimeException("已被更新");
	...
	public List<RbacRightDTO> getRightList(){
		...
		try{
			...
			rbacRight = query.unwrap( org.hibernate.query.NativeQuery.class )
                    .addScalar("rightName",StandardBasicTypes.STRING)
	...
	private String getRoleRightSQL() {
	...
	private String getMaxRoleCodeSQL() {
		StringBuffer objSqlContent = new StringBuffer();
	...
	private String getUpdataTimeSQL() {
