...
public class QmsProcessInformationsController {
	...
	private final Logger log = LoggerFactory.getLogger(QmsProcessInformationsController.class);
	...
	public QmsProcessInformationsController(QmsBomTechnologyRepository qmsBomTechnologyRepository,
			QmsBomRepository qmsBomRepository,
			QmsMaterielRepository qmsMaterielRepository,
	...
	public HashMap<String,Object> getDictionaryTess(@RequestBody HashMap<String,Object> param){
	...
	public HashMap<String,Object> getOrganizationInfoss(@RequestBody HashMap<String,Object> param) {
	...
	@Timed
	public Integer createInfo(@RequestBody BomTechnologGroupDTO bomTechnologGroupDTO){
		// 返回结果
	...
	@Timed
	public Integer UpdateInfo(@RequestBody BomTechnologGroupDTO bomTechnologGroupDTO){
		// 返回结果
		Integer backResult=0;
		log.debug("前台传输过来的参数"+bomTechnologGroupDTO);
		log.debug("前台传输过来的参数"+bomTechnologGroupDTO.getQmsBomTechnology());
	...
	@Timed
	public ResponseEntity<BomTechnologGroupDTO> getPurchaseOrder(@PathVariable Long id) {
		// 实例化结果集
	...
	@Timed
	public Integer deleteQualityControl(@RequestBody QmsPartsAssemblyRelationOwnerDTO qmsPartsAssemblyRelationDTO) throws URISyntaxException{
	...
	@Timed
	public Integer deletePartsAssembly(@RequestBody QmsQualityControlDetails qmsQualityControlDetails)throws URISyntaxException{
		Integer resultInfo = 0;
	...
	@Timed
	@Transactional
	public Integer deleteAllInfo(@PathVariable Long id) {
		// 返回结果实例化
		Integer backInfo = 0;
		List<QmsProductionInspection> qmsProductionInspection = new ArrayList<QmsProductionInspection>();
		try {
...
//					throw new RuntimeException("更新默认工艺失败");
	...
	@Timed
	public ResponseEntity<BomTechnologGroupDTO> getEnclosure(@PathVariable Long id) {
		// 实例化结果集
		BomTechnologGroupDTO  bomTechnologGroupDTO= new BomTechnologGroupDTO();
		// 实例化结果集：工艺文件
		List<QmsEnclosure> qmsEnclosure = new ArrayList<QmsEnclosure>();
	...
	public HashMap<String,Object> copyProcessInfo(@RequestBody HashMap<String,Object> param) {
		// 返回值设置
	...
	@Timed
	public ResponseEntity<BomTechnologGroupDTO> getEnclosureList(@PathVariable Long id){
		// 实例化结果集
		BomTechnologGroupDTO  bomTechnologGroupDTO= new BomTechnologGroupDTO();
