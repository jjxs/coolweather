...
public class HostSlaveInit {
	...
	private final Logger log = LoggerFactory.getLogger(HostSlaveInit.class);
	...
	private static final String HST_STARTING_MESSAGE = "Starting Host Or Slave Initialize";
	 ...
	 * @return
	 */
	private String saveSlaveInfomation() {
		...
		try {
			...
			String ret = this.httpRequest.getData(hostUrl + "/hst-api/host/hst-server-info-details", 
					HttpRequest.HttpMode.POST, JSON.toJSONString(postHstServer), this.getHostToken());
...
//			hstServerInfoDetailsRepository.saveAll(hstServerInfoDetailss);
	 ...
	 * @return
	 */
	private Map<String, String> getHostToken() {
	 ...
	 * @return
	 */
	private String getAndSaveHostRbacUser() {
