...
@Service
public class QmsSupplierClassServiceImpl implements QmsSupplierClassService {

    private final Logger log = LoggerFactory.getLogger(QmsUnitServiceImpl.class);
    ...
    public QmsSupplierClassServiceImpl(QmsSupplierClassRepository qmsSupplierClassRepository){
