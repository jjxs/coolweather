...
@Service
public class QmsBomTechnologyServiceImpl implements QmsBomTechnologyService {
    ...
    public List<QmsBomTechnologyDTO> qmsTechnologyFindAll(String materielCdIn, String materielNameIn, String technologyNameIn){
        ...
        try {
            ...
            QmsBomTechnologyDTO = query.unwrap(org.hibernate.query.NativeQuery.class)
                .addScalar("technologyId", StandardBasicTypes.LONG)
                ...
                .addScalar("jhiDescribe", StandardBasicTypes.STRING)
    ...
    String getfindAllSql(String materielCdIn, String materielNameIn,String technologyNameIn) {
