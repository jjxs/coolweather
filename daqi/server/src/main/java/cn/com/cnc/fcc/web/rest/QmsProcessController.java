...
public class QmsProcessController {
    ...
    private final Logger log = LoggerFactory.getLogger(QmsProcessController.class);
	 ...
	 * 工序POP画面一览
	 *
	 * @param processCd 模糊查询参数
     * @param processName 模糊查询参数
	 * @return
	 * @throws URISyntaxException
	 */
    @GetMapping("/qms-processes/getProcessInfo/index")
    @Timed
    public ResponseEntity<List<QmsProcess>> getgetProcessInfoForCodeName(HttpServletRequest request,Pageable pageable) throws URISyntaxException {
