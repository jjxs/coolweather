    ...
    RouterModule.forRoot(
      [
        ...
        },
        {
          ...
          loadChildren: '.crrc/vehicle-type-class/qms-vehicle-type-class.module#FccQmsVehicleTypeClassModule'
        }, {
          path: 'supplierClass',
          ...
          path: 'product',
          loadChildren: './product/qms-product.module#FccQmsProductModule'
        }, {
          path: 'process-informations',
          loadChildren: './crrc/process-informations/process-informations.module#FccProcessInformationsModule'

        }, {
          path: 'productProcessSelfCheck',
          loadChildren: './crrc/productProcessSelfCheck/qms-production-inspection.self.module#FccQmsProductionInspectionSelfModule'
        }
      ],
