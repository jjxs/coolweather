...
export class QmsProductionInspectionUpdateSelfComponent implements OnInit {
    ...
    save() {
        ...
        if (this.qualityControlDetailsErrorList.size >0) {
            ...
            this.qualityControlDetailsErrorList.forEach(function (element, sameElement, set) {
                if (this.qmsQualityControlDetails[element].abcType == 'A' ) {
                    console.log('a')
                }
            })

            // for (var j in this.qualityControlDetailsErrorList){
            //     console.log('error',this.qmsQualityControlDetails[this.qualityControlDetailsErrorList[j].value])
            ...
            // this.qmsProductionInspectionService.createQmsUnqualifiedProduct().subscribe(data => {
