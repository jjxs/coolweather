...
export class QmsProductionInspectionUpdateSelfComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ qmsProductionInspection }) => {
            ...
            this.qmsProductionInspectionService
                .findAssemblyRelationByTechId({ pid: qmsProductionInspection.id })
                .subscribe(data => {
    ...
    async save() {
        ...
        await this.qmsProductionInspectionService.checkProductionRelation({params: this.qmsPartsAssemblyRelation}).subscribe(data => {
            console.log("data", data)

            if (data.body.result.code === '2') {
        ...
        const params = {
            qpi : this.qmsProductionInspection,
            errorList: this.errorList,
            controlLevel: this.controlLevel,
            qpar: this.qmsPartsAssemblyRelation,
        }   


        await this.qmsProductionInspectionService.saveAll(params).subscribe(data => {
