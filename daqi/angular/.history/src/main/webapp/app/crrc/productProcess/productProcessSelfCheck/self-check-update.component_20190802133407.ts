...
export class QmsProductionInspectionUpdateSelfComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ qmsProductionInspection }) => {
            ...
            // this.isOkName = this.checkStatusFormat()
    ...
    qualityInspectionCheck() {
        ...
        for (var i = 0; i < this.qmsQualityControlDetails.length; i++) {
            ...
            console.log(isNaN(parseInt(this.qmsQualityControlDetails[i].testValue)))
            console.log((this.qmsQualityControlDetails[i].testValue.toString() !=='Y' && this.qmsQualityControlDetails[i].testValue.toString() !== 'N'))

            if (isNaN(parseInt(this.qmsQualityControlDetails[i].testValue)) && (this.qmsQualityControlDetails[i].testValue.toString() !=='Y' && this.qmsQualityControlDetails[i].testValue.toString() !== 'N')){
