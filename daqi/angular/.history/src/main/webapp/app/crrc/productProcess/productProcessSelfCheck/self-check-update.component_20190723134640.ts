...
export class QmsProductionInspectionUpdateSelfComponent implements OnInit {
    ...
    test(i) {
        console.log(this.qualityControlDetailsErrorList)
        for (var j=0; j< this.qualityControlDetailsErrorList.size; j++) {
            console.log(this.qualityControlDetailsErrorList[j].value)
            console.log(this.qualityControlDetailsErrorList[j])
