...
export class QmsProductionInspectionUpdateSelfComponent implements OnInit {
    ...
    qualityInspectionCheck() {
        ...
        for (var i = 0; i < this.qmsQualityControlDetails.length; i++) {
            ...
            if (!isNaN(this.qmsQualityControlDetails[i].testValue) && (this.qmsQualityControlDetails[i].testValue.toString() !=='Y'||this.qmsQualityControlDetails[i].testValue.toString() !== 'N')){
