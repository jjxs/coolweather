...
@NgModule({
    imports: [TabViewModule, CheckboxModule, RadioButtonModule, DropdownModule, TableModule, PanelModule, ButtonModule, GrowlModule, FccSharedModule, RouterModule.forChild(ENTITY_STATES)],
    declarations: [
        QmsProductionInspectionSelfComponent,
        QmsProductionInspectionUpdateSelfComponent
    ],
