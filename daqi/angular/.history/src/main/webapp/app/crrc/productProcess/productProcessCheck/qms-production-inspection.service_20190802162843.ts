...
export class QmsProductionInspectionService {
    ...
    //批量任务生成
    doBatchGeneration(qmsProductionInspection: any): Observable<EntityResponseType> {
        // const copy = this.convertDateFromClient(qmsProductionInspection);
        return this.http
            .post<any>('api/productProcess/doBatchGeneration', qmsProductionInspection, { observe: 'response' })
            // .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }
