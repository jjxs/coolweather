...
import { RbacRoleSelectionComponent } from './rbacRoleSelection.component';
...
export class RbacRoleSelectionResolve implements Resolve<IRbacRole> {
    constructor(private service: RbacRoleSelectionService) {}
...
export const RbacRoleSelectionRoute: Routes = [
    {
        path: 'rbacRoleSelection',
        component: RbacRoleSelectionComponent,
        data: {
            authorities: [],
