...
export class QmsEntryInspectionComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.qmsEntryInspectionService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IQmsEntryInspection[]>) => this.paginateQmsEntryInspections(res.body, res.headers),
    ...
    private paginateQmsEntryInspections(data: IQmsEntryInspection[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.qmsEntryInspections = data;
    }
