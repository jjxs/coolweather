...
export class QmsProductionInspectionSelfService {
    ...
    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<IQmsProductionInspection>(`api/productProcessSelfCheck/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }
    ...
    query(req?: any): Observable<EntityArrayResponseType> {
        ...
        return this.http
            .get<IQmsProductionInspection[]>('api/productProcessSelfCheck/productProcessSelfFindAll', { params: options, observe: 'response' })
    ...
    chackPreProcess(req?: any): Observable<any> {
        return this.http
        .post<any>('api/productProcessSelfCheck/chackPreProcess', req, {observe: 'response' })
    }
    ...
    deleteCheck(req?: any): Observable<any> {
        return this.http
            .get<any[]>('api/productProcessSelfCheck' +'/deleteCheck', { params: req, observe: 'response' })
    }
    ...
    // 新增到生产检验装配关系表
    createProductionRelation(req?: any): Observable<any> {
        return this.http
        .post<any>('api/productProcessSelfCheck/createProductionRelation', req, {observe: 'response' })
    }


    // 保存所有
    saveAll(req?: any): Observable<any> {
        return this.http
        .post<any>('api/productProcessSelfCheck/saveAll', req, {observe: 'response' })
    }

    // 获取附件List
    obtainFile(options?: any): Observable<any> {
        return this.http
            .get<any[]>('api/productProcessSelfCheck/obtainFile', { params: options, observe: 'response' })
    }

    // 删除全部信息
    deleteAll(options?: any): Observable<any> {
        return this.http
            .get<any[]>('api/productProcessSelfCheck/deleteAll', { params: options, observe: 'response' })
    }
