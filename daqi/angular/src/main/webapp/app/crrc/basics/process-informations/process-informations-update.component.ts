        ...
        if (this.editDistinguish) {
            this.processInformationsService.updateInfo({
                ...
                if (data.body === 1) {
                    ...
                    this.filePath = this.materielCd + '/' + this.qmsVehicleTypeInfo.technologyCd + '/' + this.processCd + '/';
    ...
    */
    ...
    viewFile(id) {
        ...
        if (imgType.indexOf(fileType) >= 0 || videoType.indexOf(fileType) >= 0 || pdfType.indexOf(fileType) >= 0) {
            ...
            this.http.get(this.fileAddress + '/imgServer/viewFile', { responseType: 'blob', params }).subscribe(
                data => {
                    console.log(data);
    ...
    uploadFlowFiles(id) {
        ...
        this.http.post(this.fileAddress + '/imgServer/upLoadAllImage', formData).subscribe(
            data => {
                console.log(data);
