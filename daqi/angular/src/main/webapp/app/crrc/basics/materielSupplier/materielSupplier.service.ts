...
export class QmsMaterielSupplierService {
    ...
    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<IQmsMaterielSupplier>(`${this.resourceUrl}/view/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }
    ...
    findMateriel(req?: any): Observable<any> {
        ...
        return this.http
            .get<any>(this.resourceUrl + '/materiel', { params: options})
    }

    findSupplier(req?: any): Observable<any> {
        const options = createRequestOption(req);
        return this.http
            .get<any>(this.resourceUrl + '/supplier', { params: options})
    }

    updateMS(req?: any): Observable<any> {
        const options = createRequestOption(req);
        return this.http
            .get<any>(this.resourceUrl + '/update', { params: options})
    }
    
    createMS(req?: any): Observable<any> {
        const options = createRequestOption(req);
        return this.http
            .get<any>(this.resourceUrl + '/create', { params: options})
    }

    query(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http
            .get<IQmsMaterielSupplier[]>(this.resourceUrl + '/search', { params: options, observe: 'response' })
