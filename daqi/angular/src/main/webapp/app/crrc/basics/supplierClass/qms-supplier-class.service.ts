...
export class QmsSupplierClassService {
    ...
    query(req?: any): Observable<EntityArrayResponseType> {
        ...
        return this.http
            .get<IQmsSupplierClass[]>(this.resourceUrl+'/index', { params: options, observe: 'response' })
    ...
    deleteCheck(req?: any): Observable<any> {
        ...
        const options = createRequestOption(req);
        return this.http
            .get<IQmsSupplierClass[]>(this.resourceUrl+'/deleteCheck', { params: options, observe: 'response' })
    }
