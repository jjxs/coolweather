...
@Component({
    ...
    templateUrl: './qms-materiel-entry-delete-dialog.component.html'
})
export class QmsMaterielEntryDeleteDialogComponent {
...
export class QmsMaterielEntryDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ qmsMaterielEntry }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(QmsMaterielEntryDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
